describe('Slideshow with Slick', () => {
  ...
  it('Single Slideshow', () => {
    cy.visit('/patterns/01-molecules-05-media-02-slideshow/01-molecules-05-media-02-slideshow.rendered.html')
  ...
  it('Slideshow with thumbnails', () => {
    cy.visit('/patterns/01-molecules-05-media-02-slideshow-thumbnails/01-molecules-05-media-02-slideshow-thumbnails.rendered.html')
